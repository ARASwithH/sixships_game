...
pygame.mixer.music.load('assets/mainmusic.mp3')
move2 = pygame.mixer.Sound("assets/move2.wav")
victory = pygame.mixer.Sound("assets/win1.wav")
...
while True:
    for event in pygame.event.get():
        ...
        if event.type == pygame.MOUSEBUTTONUP:
            ...
            if 350 < pos[0] < 402 and 625 < pos[1] < 675:
                pygame.mixer.music.pause()
            if 298 < pos[0] < 348 and 625 < pos[1] < 675:
